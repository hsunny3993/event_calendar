...
Job.transaction do
  ...
  job1 = Job.create(name: 'job1', client_id: client1.id, start_time: '2022-10-17 18:23:00', end_time: '2022-10-19 15:33.57')
  ...
  job2 = Job.create(name: 'job2', client_id: client2.id, start_time: '2022-10-17 19:00:00', end_time: '2022-10-19 21:43.57')
